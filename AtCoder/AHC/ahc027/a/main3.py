...
def Input():
    global n,h,v,d,UDLR,ans,x,y,dirt,weight,visited_start,visited_goal,visited_mid,count,visited_coordinate
    count = 0
    ...
    while count < 10 ** 5 - 50000:
        ...
        for i,j in enumerate(Vec):
            if j and 0 <= x+around4[i][0] < n and 0 <= y+around4[i][1] < n:
                ...
                l.append( dirt[x+around4[i][0]][y+around4[i][1]]*calc_around_avr(x+around4[i][0],y+around4[i][1]) * (1 - 100 * visited_mid[x+around4[i][0]][y+around4[i][1]] / (10000 + count)))
...
#         Input_file_name = i
#         Output_file_name = f"main5_{Input_file_name:04}"
#         Input_file()
#         mid()
#         All_visit()
#         goal()
