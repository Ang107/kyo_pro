...
var
    n, m = ii()
    d = newSeqWith(n, newSeqWith(n, true))
...
var kakutei_person = newSeqWith(n, -2)
var kakutei_number = newSeqWith(n, -2)
var cnt = 0
while true:
    cnt += 1
    if cnt % 100 == 0 and cpuTime() - START > 1.5:
        break
    var tateyoko = rand(1)
    if tateyoko == 0:
        var person = rand(n-1)
...
var ans = newSeqOfCap[int](n)
for i in kakutei_person:
    ans.add(i+1)
# echo cnt
echo ans.join(" ")
