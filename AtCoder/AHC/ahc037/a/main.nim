...
proc solve(self: var Solver, output: var Output) =
    ...
    #         echo (k, v.deduplicate())



    # var new_cand = clean_cand(cand, actions, self.input)
    # actions = make_actions(new_cand)
    # optimize_actions(new_cand, actions)
